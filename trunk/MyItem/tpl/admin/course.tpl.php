...
extract($arr);
extract($pageInfo);
$type = array('','前台课程','后台课程');
?>
<div id="News-Manage">
	<p><b><?php echo $type[$tid]; ?></b>(共<?php echo $totalNum; ?>项)</p>
	<div id="news-top">
		<input type="button" value="批量删除" onclick="return delAll('#delform')" />
		
		<input type="button" name="add" value="添加课程" onclick="location.href='<?php echo URL.'&do=add'; ?>'" />
	...
	<tr>
		<td colspan="6" class="td-bottom"  nowrap>
			选择： <a href="javascript:all();">全选</a>
			 ...
			 - <a href="<?php echo URL.'&do=add'; ?>">添加课程</a>
		</td>
	</tr>
	<tr>
