...
.news-list .th3{ width:20%;}
.news-list .th4{ width:40%;}
...
?>
<div id="News-Manage">
	<p><b>急聘专区</b>(共<?php echo $totalNum; ?>条)</p>
	<div id="news-top">		
		<table width="100%">
			<tr>
				<td nowrap="nowrap">
...
<table border="0" cellspacing="1" cellpadding="0" class="news-list" ondblclick="$('#addform').toggle();">
	<tr>
		...
		<th class="th4" nowrap>url地址</th>
		<th class="th5" nowrap>时间</th>
	...
	<form method="POST" action="<?php echo URL; ?>">
	    ...
	    <td><input type="text" name="url" size="25" value="http://" style="width:300px;"></td>
	    <td><input type="text" name="time" size="50" style="width:80px;" class="_calendar"></td>
...
<!--数据循环开始 -->
	...
	<tr>
		...
		<td class="td3" nowrap><?php echo $company; ?></td>
		<td class="td4" nowrap><?php echo $url; ?></td>
		<td class="td5" nowrap><?php echo $time; ?></td>
