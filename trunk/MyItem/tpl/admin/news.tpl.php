...
.news-list .th3{ width:60%; text-align:left; padding-left:20px;}
...
extract($arr);
extract($pageInfo);
$type = array('','企业新闻','行业新闻');
?>
<div id="News-Manage">
	<p><b><?php echo $type[$tid]; ?></b>(共<?php echo $totalNum; ?>条)</p>
	<div id="news-top">
		<input type="button" value="批量删除" onclick="return delAll('#delform')" />
		
		<input type="button" name="add" value="添加新闻" onclick="location.href='<?php echo URL.'&do=add'; ?>'" />
...
<table border="0" cellspacing="1" cellpadding="0" class="news-list">
	<tr>
		...
		<th class="th2" nowrap><img src="public/images/admin/news-b.gif" /></th>
		<th class="th3" nowrap>新闻标题</th>
		<th class="th4" nowrap>更新日期</th>
...
<!--数据循环开始 -->
	...
	<tr>
		...
		<td class="td2" nowrap><img src="public/images/admin/news-b.gif" /></td>
	...
	<tr>
		<td colspan="6" class="td-bottom"  nowrap>
			选择： <a href="javascript:all();">全选</a>
			 ...
			 - <a href="<?php echo URL.'&do=add'; ?>">添加新闻</a>
		</td>
	</tr>
	<tr>
		<td colspan="6" class="page" nowrap>
			<ul><?php echo $buttonBasic; echo $buttonSelect; ?></td></tr>
</table>
<!--新闻列表结束 -->
