...
#stu_con .tab1 .img_td img{ width:207px; height:252px; border:1px solid #666; background:url(images/stu_bg.gif) no-repeat center center;}
...
?>
<div id="content_news">
	<h5>教师信息添加</h5><span class="back"><a href="javascript:history.back();">返回</a></span>
	...
	<input type="hidden" name="tid" value="1" />
		<table cellspacing="0" cellpadding="0" border="0" class="tab1">
			<tr><td nowrap="nowrap">请上传207*252比例的照片</td></tr>
		...
		<table border="0" cellspacing="0" cellpadding="0"  class="tab2">
		      <tr>
				...
				<td><input type="text" name="list_id" value="<?php echo $id; ?>" style="width:30px;"></td>
			</tr>	
			<tr>
				<td class="td1">姓名：</td>
			...
			<tr>
				...
				<td><textarea name="introduction" cols="60" rows="6" /><?php echo $introduction; ?></textarea></td>
			</tr>			
			<tr>
				<td class="td1">感言：</td>
				<td class="td2"><textarea name="say" cols="60" rows="6" /><?php echo $say; ?></textarea></td>
			</tr>
			<tr>
				<td></td>
				<td class="td3">
