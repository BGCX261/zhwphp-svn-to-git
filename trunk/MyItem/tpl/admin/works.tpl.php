...
#student ul{ list-style-type:none; display:block; float:left; margin-left:18px; margin-top:20px;height:94px;}
#student ul li{ display:block; text-align:center; width:124px; color:#666;}
#student ul .img_li a{ display:block; width:124px; height:94px; border:2px solid #fff; padding:2px;}
#student ul .img_li a:hover{ border:2px solid #b6c3d4;}
#student ul .img_li img{ width:122px; height:92px;}
...
extract($arr);
extract($pageInfo);
$type = array('','前台作品','后台作品');
?>
<div id="student-manage">
	<p><b><?php echo $type[$tid]; ?></b>(共<?php echo $totalNum; ?>个)</p>
	<div id="news-top">
		<input type="button" name="del" value="批量删除" style=" color:#F00;" onclick="return delAll('#delform')"/>
		<input type="button" name="del" value="添加作品" onclick="location.href='<?php echo URL.'&do=add'; ?>'" />
...
<div id="student">
	...
	?>
	<ul>
		<li class="img_li"><a href="<?php echo URL.'&do=edit&id='.$id; ?>"><img src="<?php echo $url; ?>" /></a></li>
	...
	<tr>
		<td colspan="7" class="td-bottom"  nowrap>
			选择：<span class="hide"><a href="javascript:all();">全选</a>
			 ...
			 - <a href="<?php echo URL.'&do=add'; ?>">添加作品</a>
		</td>
	</tr>
	<tr>
