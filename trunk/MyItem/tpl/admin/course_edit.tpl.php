...
<div id="news-content">
		...
		<table border="0" cellspacing="0" cellpadding="0">
			<tr>
				...
				<input type="hidden" value="<?php echo $tid; ?>" id="tid">
					<select name="tid">
						<option value="1">前台课程</option>
						<option value="2">后台课程</option>
					</select>
	...
	<div class="nc-zhongjian">
		<table border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				<td class="td1" nowrap>简介:</td>
				<td height="100"><textarea rows="4" cols="70" name="introduction"><?php echo $introduction; ?></textarea></td>
			</tr>								
		</table>
