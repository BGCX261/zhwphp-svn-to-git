...
class UpFile
{
    ...
    private function validate()
    {
        ...
        if (!$this->chkSize()) {$this->error('大小参出允许 '.$this->byteFormat($this->maxSize*1024));return false;}
    ...
    {
        $this->setSaveInfo('error',"文件名：{$this->getUploadInfo('name')}\r\n错误：{$error}");
    }
}
?>